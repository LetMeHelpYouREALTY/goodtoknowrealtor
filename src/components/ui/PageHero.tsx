...
export type PageHeroProps = {
  ...
  /** When false, skips the office listings band below the hero. Default: true */
...
export function PageHero({
  ...
  return (
    <>
      <section
        className={`relative py-16 lg:py-24 text-white bg-gradient-to-br ${gradientFromClassName} ${gradientToClassName}`}
      >
      ...
      {showOfficeListings ? <RealScoutOfficeWidget compact /> : null}
    </>
  );
}
